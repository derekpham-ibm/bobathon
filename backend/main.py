...
TASKS_BY_ROLE = {
    UserRole.DEVELOPER: [
        ...
        },
        {
            ...
            "description": "Install required tools: VS Code, Git, Docker, Node.js",
            "category": "Technical Setup",
            "status": TaskStatus.PENDING,
            "priority": "high",
            "estimated_time": "3 hours",
            "due_date": "2026-06-22",
            "dependencies": ["task_dev_003"],
            "resources": ["res_004", "res_005"]
        },
        {
            "id": "task_dev_005",
            "title": "Request GitHub Access",
            "description": "Submit request for IBM GitHub Enterprise access",
            "category": "Technical Setup",
            "status": TaskStatus.PENDING,
            "priority": "medium",
        ...
        },
        {
            ...
            "description": "Set up your first one-on-one meeting",
        ...
        },
        {
            ...
            "description": "Join #engineering, #team-backend, #random",
            "category": "Team Integration",
            "status": TaskStatus.PENDING,
            "priority": "medium",
            "estimated_time": "10 minutes",
        ...
        {
            "id": "task_dev_008",
            "title": "Complete IBM Cloud Fundamentals",
            "description": "Online course covering IBM Cloud basics",
            "category": "Training",
            "status": TaskStatus.PENDING,
            "priority": "low",
